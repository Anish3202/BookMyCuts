    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
          scrolled
            ? 'bg-[#080808]/95 backdrop-blur-md border-b border-white/10 shadow-2xl py-1'
            : 'bg-[#080808]/80 backdrop-blur-sm border-b border-white/5 py-2'
        }`}
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 z-30 bg-[#080808] flex flex-col pt-28 px-8"
          >
